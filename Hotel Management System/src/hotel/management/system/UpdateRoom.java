...
public class UpdateRoom extends JFrame implements ActionListener {
    ...
    { 
        ...
        try{
            Conn c= new Conn();
            ResultSet rs= c.s.ececuteQuery("select * from customer");
            while(rs.next())
            {
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource()== check)
        {
            ...
            try{
                ...
                while(rs2.next())
                {
                   ...
                   tfstatus.setText(rs2.getSting("cleaning_status"));
        ...
        else if(ae.getSource()== update)
        {
            ...
            try{
                Conn c= new Conn();
                c.s.executeQuery("update customer set availability= '"+available+"', cleaning_status= '"+status+"' where roomnumber= '"+room+"'");
