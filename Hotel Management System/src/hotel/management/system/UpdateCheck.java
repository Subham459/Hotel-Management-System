...
public class UpdateCheck extends JFrame implements ActionListener {
    ...
    { 
        ...
        pending.setBounds(30,240,100,20);
        add(pending);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource()== update)
        {
            ...
            try{
                Conn c= new Conn();
                c.s.executeQuery("update customer set room= '"+room+"', name= '"+name+"', checkintime = '"+checkin+"',deposit= '"+deposit+"' where number='"+number+"'");
